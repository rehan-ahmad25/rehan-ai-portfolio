const projects = [
  ...
  description:
    "Built and trained AstraGPT, a custom GPT-style language model from scratch using PyTorch. Implemented tokenizer training, text preprocessing, token and positional embeddings, multi-head self-attention, Transformer blocks, next-token prediction, and autoregressive text generation to explore the complete Large Language Model development pipeline.",
